...
public class CalendarIntervalTriggerImpl extends AbstractTrigger<CalendarIntervalTrigger> implements CalendarIntervalTrigger, CoreTrigger {
    ...
    public Date computeFirstFireTime(org.quartz.Calendar calendar) {
        nextFireTime = new Date(getStartTime().getTime() - this.getAdvance());
    ...
    public Date getFireTimeAfter(Date afterTime)
    {
    	...
    	Date TrigTime = new Date(afterTime.getTime() + this.getAdvance());
    	Date nextTime = getFireTimeAfter_orign(TrigTime);
    	if ( nextTime== null)
    		return null;
    	return new Date(nextTime.getTime()- this.getAdvance());
    }
    
    
    public Date getFireTimeAfter_orign(Date afterTime) {
        return getFireTimeAfter_orign(afterTime, false);
    }
    
    protected Date getFireTimeAfter_orign(Date afterTime, boolean ignoreEndTime) {
        if (complete) {
            return null;
        }
    ...
    public Date getFinalFireTime() {
        ...
        fTime = getFireTimeAfter_orign(fTime, true);
